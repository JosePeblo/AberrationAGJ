...
Animator::Animator(Animation* anim)
{
    ...
    for(int i = 0; i < 100; ++i)
        m_FinalBoneMatrices.emplace_back(cml::identity4);
}
...
void Animator::UpdateAnimation(float dt)
{
    ...
    if(m_CurrentAnimation)
    {
        ...
        CalculateBoneTransform(&m_CurrentAnimation->GetRootNode(), cml::identity4);
    }
}
...
std::vector<mat4> Animator::GetFinalBoneMatrices() { return m_FinalBoneMatrices; }
